...
if (!function_exists('tgl_indo'))
{
  function tgl_indo($date) {  //---------- Script Ubah hari dan bulan indonesia
    ...
    //$hari = array (1 => 'Sn','Sl','Ra','Ka','Ju','Sa','Mi');
...
if (!function_exists('modal')) {
  ...
  function modal($title, $modul, $function, $prm1 = null, $prm2 = null, $prm3 = null, $prm4 = null, $prm5 = null) {
    return site_url('fath/modal/set_modal/' . $title . '/' . $modul . '/' . $function . '/' . $prm1 . '/' . $prm2 . '/' . $prm3 . '/' . $prm4 . '/' . $prm5);
  }
...
/* Location: ./fath-app/helpers/custom_helper.php */
