...
<!--[if gt IE 9]><!--> <html class="gt-ie8 gt-ie9 not-ie"> <!--<![endif]-->
    <head>
        ...
        <link href="<?php echo base_url(); ?>fath-assets/stylesheets/themes/yellow/pace-theme-minimal.css" media="all" rel="stylesheet" type="text/css" />	
        <link href="<?php echo base_url(); ?>fath-assets/stylesheets/fath-custom.css" media="all" rel="stylesheet" type="text/css" />	
