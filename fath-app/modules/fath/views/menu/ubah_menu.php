...
<form rel='ajax' action="<?php echo site_url('fath/menu/update_menu_proses'); ?>" class="panel form-horizontal xhr dest_subcontent-element" method="post">  
                            ...
                            if ($listFunction) {
                                foreach ($listFunction as $objFunction) {
                                    if (isset($functionId)) {
                                        ...
                                        if ($objFunction['module_detil_id'] == $objMenu['module_detil_id']) {
                                            echo "<option value='" . $objFunction['module_detil_id'] . "' selected='selected'>" . $objFunction['module_detil_function'] . "</option>";
                                        } else {
                                            echo "<option value='" . $objFunction['module_detil_id'] . "'>" . $objFunction['module_detil_function'] . "</option>";
                                        }
