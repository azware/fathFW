...
class MY_Controller extends MX_Controller {
    ...
    private function initialize() {
        ...
        $this->user_email = $this->session->userdata('_fath__email_');
...
/**
 * Class FATH_Controller
 * @created on : 11-04-2018
 * @author Azzam Najib Habibie
 * DEV-MASTER
 */
class FATH_Controller extends MY_Controller {
    ...
    private function access_right() {
        ...
        $arrayModuleAndControllerByPass = array(
            array('module' => 'fath', 'controller' => 'change_group'));
